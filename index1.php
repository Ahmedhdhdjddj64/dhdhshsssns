...
#===۞CLARN۞===#
$API_KEY = "5921676302";
$Dev = array("5921676302", "5921676302" ); //ايدي المطور 
#===۞CLARN۞===#
define('5853644654:AAGPFIYMYYqYdSaRLQ3cbYO0APACk2qliWo',$token);
...
$usernamebot = @F_G_ABOT;

$bot_id = 5853644654;

@$channel = "X6XGX";
@$token = 5853644654:AAGPFIYMYYqYdSaRLQ3cbYO0APACk2qliWo;
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت  • √",'url'=>"https://telegram.me/X6XGX"]
              ] 
              ],
        ])
            ]);
